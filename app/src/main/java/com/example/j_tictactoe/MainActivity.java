package com.example.j_tictactoe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    button1.setImageResource(R.drawable.cross2);
                    b1=1;
                    i++;
                }
                else{
                    button1.setImageResource(R.drawable.circle2);
                    b1=0;
                    i++;
                }
                choosePlayer();
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X"))
                {
                    button2.setImageResource(R.drawable.cross2);
                    b2=1;
                    i++;
                }
                else{
                    button2.setImageResource(R.drawable.circle2);
                    b2=0;
                    i++;
                }
                choosePlayer();
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X"))
                {
                    button3.setImageResource(R.drawable.cross2);
                    b3=1;
                    i++;
                }
                else{
                    button3.setImageResource(R.drawable.circle2);
                    b3=0;
                    i++;
                }
                choosePlayer();
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X"))
                {
                    button4.setImageResource(R.drawable.cross2);
                    b4=1;
                    i++;
                }
                else{
                    button4.setImageResource(R.drawable.circle2);
                    b4=0;
                    i++;
                }
                choosePlayer();
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X"))
                {
                    button5.setImageResource(R.drawable.cross2);
                    b5=1;
                    i++;
                }
                else{
                    button5.setImageResource(R.drawable.circle2);
                    b5=0;
                    i++;
                }
                choosePlayer();
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X"))
                {
                    button6.setImageResource(R.drawable.cross2);
                    b6=1;
                    i++;
                }
                else{
                    button6.setImageResource(R.drawable.circle2);
                    b6=0;
                    i++;
                }
                choosePlayer();
        ...
        button7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X"))
                {
                    button7.setImageResource(R.drawable.cross2);
                    b7=1;
                    i++;
                }
                else{
                    button7.setImageResource(R.drawable.circle2);
                    b7=0;
                    i++;
                }
                choosePlayer();
        ...
        button8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X"))
                {
                    button8.setImageResource(R.drawable.cross2);
                    b8=1;
                    i++;
                }
                else{
                    button8.setImageResource(R.drawable.circle2);
                    b8=0;
                    i++;
                }
                choosePlayer();
        ...
        button9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X"))
                {
                    button9.setImageResource(R.drawable.cross2);
                    b9=1;
                    i++;
                }
                else{
                    button9.setImageResource(R.drawable.circle2);
                    b9=0;
                    i++;
                }
                choosePlayer();
